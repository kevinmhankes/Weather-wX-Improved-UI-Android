 ...
 */
public class ExternalGeodeticMeasurement extends ExternalGeodeticCurve
{
   /**
    ...
    */
   private ExternalGeodeticMeasurement(double ellipsoidalDistance, double azimuth, double reverseAzimuth, double elevationChange)
   {
    ...
    *           starting point to the ending point
    */
   public ExternalGeodeticMeasurement(ExternalGeodeticCurve averageCurve, double elevationChange)
   {
