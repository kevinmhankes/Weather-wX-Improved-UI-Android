...
internal object UtilityModelNCEPInterface {
    ...
    val MODEL_WW_3_ENP_PARAMS = listOf(
            "regional_pk_dir_per",
            "regional_wv_dir_per",
            "regional_wv_ht"
    )

    val MODEL_WW_3_ENP_PARAMS_LABELS = listOf(
    ...
    val MODEL_WW_3_WNA_PARAMS = listOf(
            "regional_pk_dir_per",
            "regional_wv_dir_per",
            "regional_wv_ht"
    )

    val MODEL_WW_3_WNA_PARAMS_LABELS = listOf(
            "Regional WW3 Model Peak Wave Direction and Period",
            "Regional WW3 Model Wind Wave Direction and Period",
            "Regional WW3 Model Sig Wave Height and Wind"
    )

    val MODEL_ESTOFS_PARAMS = listOf(
            "storm_surge",
            "total_water_level"
    )

    val MODEL_ESTOFS_PARAMS_LABELS = listOf(
            "Storm surge relative to Mean Sea Level (feet)",
            "Total Water Level relative to Mean Sea Level (feet)"
    )

    val MODEL_FIREWX_PARAMS = listOf(
            "precip_p01",
            "precip_p12",
            "precip_p24",
            "precip_p36",
    ...
    val MODEL_FIREWX_PARAMS_LABELS = listOf(
