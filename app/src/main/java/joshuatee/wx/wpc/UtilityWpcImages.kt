...
//        MyApplication.nwsWPCwebsitePrefix + "/noaa/noaad3.gif",
        ...
        MyApplication.nwsWPCwebsitePrefix + "/medr/display/wpcwx+frontsf072.gif",
        MyApplication.nwsWPCwebsitePrefix + "/medr/display/wpcwx+frontsf096.gif",
        MyApplication.nwsWPCwebsitePrefix + "/medr/display/wpcwx+frontsf120.gif",
        MyApplication.nwsWPCwebsitePrefix + "/medr/display/wpcwx+frontsf144.gif",
        MyApplication.nwsWPCwebsitePrefix + "/medr/display/wpcwx+frontsf168.gif",
        ...
        "${MyApplication.nwsWPCwebsitePrefix}/wwd/day1_psnow_gt_04_conus.gif",
        "${MyApplication.nwsWPCwebsitePrefix}/wwd/day1_psnow_gt_08_conus.gif",
        "${MyApplication.nwsWPCwebsitePrefix}/wwd/day1_psnow_gt_12_conus.gif",
        "${MyApplication.nwsWPCwebsitePrefix}/wwd/day1_pice_gt_25_conus.gif",
        "${MyApplication.nwsWPCwebsitePrefix}/wwd/day2_psnow_gt_04_conus.gif",
        "${MyApplication.nwsWPCwebsitePrefix}/wwd/day2_psnow_gt_08_conus.gif",
        "${MyApplication.nwsWPCwebsitePrefix}/wwd/day2_psnow_gt_12_conus.gif",
        "${MyApplication.nwsWPCwebsitePrefix}/wwd/day2_pice_gt_25_conus.gif",
        "${MyApplication.nwsWPCwebsitePrefix}/wwd/day3_psnow_gt_04_conus.gif",
        "${MyApplication.nwsWPCwebsitePrefix}/wwd/day3_psnow_gt_08_conus.gif",
        "${MyApplication.nwsWPCwebsitePrefix}/wwd/day3_psnow_gt_12_conus.gif",
        "${MyApplication.nwsWPCwebsitePrefix}/wwd/day3_pice_gt_25_conus.gif",
