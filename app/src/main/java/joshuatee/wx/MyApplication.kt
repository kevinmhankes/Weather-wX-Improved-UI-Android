...
class MyApplication : Application() {
    ...
    companion object {
        ...
        const val emailAsString = "joshua.tee@gmail.com"
        ...
        var cardElevation = 0f
        var fabElevation = 0f
        var fabElevationDepressed = 0f
        var elevationPref = 0f
        var elevationPrefDefault = 5
        var textSizeSmall = 0f
        var textSizeNormal = 0f
