 ...
 */
/* This version incorporated into the uk.ac.starlink.util package by
 * Mark Taylor (Starlink); the only changes were:
 *   - changing the package name
 *   - overriding InputStream's markSupported method to return false
 */
